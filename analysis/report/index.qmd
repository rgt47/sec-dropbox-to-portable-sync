...
1. Post 31: [Research Backup Architecture](../31-githubarchive/)
2. **Post 32: Migrating Off Dropbox: Beyond Dotfiles** (this post)
3. Post 33: [Setting Up pass: a Unix Password Manager](../33-unix-pass-setup/)
4. Post 34: [Secrets Management for the Workflow Construct](../34-secrets-management/)
5. Post 35: [Security Foundations for a Multi-Laptop Research Cluster](../35-multi-laptop-security/)
