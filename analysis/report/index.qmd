...
YAML FRONT MATTER (lines 1-20)
  ...
  [x] draft: true    — flip when imagery in place and render verified
...
![A wooden desk seen from above with three small index cards arranged in a horizontal row, each card showing a hand-drawn symbol, suggesting classification before action.](media/images/ambiance1.png){.img-fluid}
...
![Two open-top boxes side by side on a workbench, the left box full of mixed objects and the right box divided into three sorted compartments, with a single object mid-transfer between them.](media/images/ambiance2.png){.img-fluid}
...
![A closed wooden chest with three small brass clasps on a stone surface, an open notebook and a capped fountain pen beside it, suggesting a deliberate and completed reorganisation.](media/images/ambiance3.png){.img-fluid}
